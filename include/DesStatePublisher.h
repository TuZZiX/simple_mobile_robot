#ifndef DES_STATE_PUBLISHER_H_
#define DES_STATE_PUBLISHER_H_

#include <queue>
#include <TrajBuilder.h> //has almost all the headers we need
...
const double accel_max = 0.8; //1m/sec^2
const double alpha_max = 0.2; // rad/sec^2
const double speed_max = 0.4; //1 m/sec
...
private:
    ...
    ros::Subscriber append_path_subscriber_;
    ...
    void appendPathQueueCB(const nav_msgs::Path &path) ;
